...
---
과제 영상링크 01: https://drive.google.com/file/d/1r5-cY9laue0XbewLtQ_KWJYeGnnRHNlI/view?usp=sharing
...
3. 필터를 적용하여 값 안정화
4. ADC 변환 값을 센서 특성에 맞는 거리 (cm) 단위로 환산
5. 계산된 거리 데이터를 UART로 PC 시리널 터미널에서 출력
